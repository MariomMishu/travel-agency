		...
		<div class="p-5 card card-primary card-outline">
			...
			<div class="text-center">
				...
				<form:form class="user form-horizontal" modelAttribute="postRm" enctype="multipart/form-data"
					action="${pageContext.request.contextPath }/post/add" method="POST">
					
					
					<div class="form-group row">
						<label align="left" class="col-sm-3">Title</label>
						<div class="col-sm-9">
							<form:input type="text" path="title" enctype="multipart/form-data"
								class="form-control" placeholder="Title"></form:input>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<form:textarea type="text" id="inputStatus" path="status"
								class="form-control form-control-user" placeholder="Status"></form:textarea>
						</div>
					</div>
